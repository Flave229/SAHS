...
FloorButton::FloorButton(int direction) : GameObject(new ParticleModel())
{
	_orientation = direction;
}

FloorButton::FloorButton(ParticleModel* particle, int direction) : GameObject(particle)
{
	_orientation = direction;
}
...
bool FloorButton::CheckCollision(GameObject* collider, float cR, bool moveThis, bool moveCollider)
{
	if (GameObject::CheckCollision(collider, cR, moveThis, moveCollider))
	{
		SetActive(true);
		return true;
	}
...
void FloorButton::SetActive(bool activeState)
{
	...
	if (_activated) {
		if (GetOrientation() == 0) 
		{	// Down
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Down_Pressed.png"));
		}
		else if (GetOrientation() == 1) 
		{	// Left
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Left_Pressed.png"));
		}
		else if (GetOrientation() == 2) 
		{	// Up
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Up_Pressed.png"));
		}
		else if (GetOrientation() == 3) 
		{	// Right
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Right_Pressed.png"));
		}
	}
	else if (!_activated) {
		if (GetOrientation() == 0) 
		{	// Down
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Down_Unpressed.png"));
		}
		else if (GetOrientation() == 1) 
		{	// Left
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Left_Unpressed.png"));
		}
		else if (GetOrientation() == 2) 
		{	// Up
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Up_Unpressed.png"));
		}
		else if (GetOrientation() == 3) 
		{	// Right
			GetSprite()->setTexture(Director::getInstance()->getTextureCache()->addImage("Art/Level_Main_Assets/Button/Button_Right_Unpressed.png"));
		}
	}
}
